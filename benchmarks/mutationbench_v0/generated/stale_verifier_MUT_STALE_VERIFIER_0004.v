...
//
// actuator_enable is gated by stale_verifier_ok, policy_ok, and kill_switch.
...
module safe_dtl_gate (
    ...
    always @(posedge clk or negedge rst_n) begin
        if (!rst_n) begin
            ...
            actuator_enable <= ai_output && stale_verifier_ok && policy_ok && !kill_switch;
        end
    end
endmodule